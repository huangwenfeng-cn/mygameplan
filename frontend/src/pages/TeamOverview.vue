  ...
  <div class="mt-6">
    ...
    <div class="mt-8">
      <div class="mb-5 flex items-center justify-between space-x-2">
        <h2 class="text-2xl font-semibold text-ink-gray-8">项目</h2>
        <div class="flex items-stretch space-x-2">
          <TabButtons :buttons="[{ label: '进行中' }, { label: '已归档' }]" v-model="activeTab" />
      ...
      <ul role="list" class="grid grid-cols-1 gap-5 sm:grid-cols-4">
            ...
            <div>
              ...
              <p class="mt-1 text-base">
                ...
                <template v-if="project.discussions_count">
                  ...
                  <span class="text-ink-gray-6"
                    >&nbsp;{{ project.discussions_count === 1 ? '条讨论' : '条讨论' }}
                  </span>
                </template>
                <span
        ...
        >
          ...
          <div>
            <h3 class="text-lg font-medium text-ink-gray-8">新建项目</h3>
          </div>
        </button>
      </ul>
...
export default {
  ...
  computed: {
    ...
    projectsList() {
      return this.activeTab === '进行中' ? this.activeProjects : this.archivedProjects
    },
    activeProjects() {
