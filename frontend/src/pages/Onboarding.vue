  ...
  <div class="flex">
    <div class="bg-surface-menu-bar min-w-[256px] pointer-events-none min-h-screen">
      ...
      <div class="flex-1">
        ...
        <div class="mt-6 px-2">
          ...
          >
            <h3 class="text-sm text-ink-gray-5">空间</h3>
          </div>
    ...
    <div class="body-container pt-14">
      <div class="max-w-xl mx-auto">
        <div class="text-2xl font-semibold text-ink-gray-8">欢迎使用项目管理</div>

        <div class="mt-2 pt-8 border-t">
          <h2 class="text-base font-medium text-ink-gray-8 mb-2">创建你的第一个空间</h2>
          <p class="text-p-sm text-ink-gray-6">
            空间是承载讨论的地方。你可以为团队、项目或任意主题创建空间，方便讨论与组织内容。
          </p>
        ...
        <div class="mt-8 border-t pt-8">
          <h3 class="text-base font-medium text-ink-gray-8 mb-2">邀请团队成员</h3>
          ...
          <div class="mt-3">
            <FormControl
              type="textarea"
              v-model="emailInput"
              placeholder="如：jane@example.com, mary@example.com"
              :rows="3"
              class="w-full"
              @blur="validateEmails(emailInput)"
              description="多个邮箱请用逗号或换行分隔"
            />
...
const validateEmails = (emails: string) => {
  ...
  if (invalidEmails.length) {
    emailError.value = `以下邮箱格式无效：${invalidEmails.join(', ')}`
    return false
  }
  emailError.value = ''
  return true
