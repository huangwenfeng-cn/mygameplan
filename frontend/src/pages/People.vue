<template>
  <div class="flex h-full flex-col">
    <div class="flex flex-1">
      <div class="w-full">
        <PageHeader>
          <Breadcrumbs :items="[{ label: '成员', route: { name: 'People' } }]" />
          <div class="h-7"></div>
        </PageHeader>
        <div class="mx-auto w-full body-container pt-6">
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-ink-gray-7">{{ people.length }} 位成员</h2>
              ...
              >
                <div class="flex w-full sm:w-3/5 items-center">
                  ...
                  <div class="ml-3 min-w-0">
                    ...
                    >
                      <span>{{ user.discussions_count }} 帖子</span>
                      <span class="text-ink-gray-4">&middot;</span>
                      <span>{{ user.comments_count }} 回复</span>
                    </div>
                  </div>
                </div>
