    ...
    <div class="flex-1">
      <nav class="space-y-0.5 px-2">
        ...
        >
          ...
          {{ preferredHomePage === 'Discussions' ? '讨论' : preferredHomePage === 'Spaces' ? '空间' : preferredHomePage }}
          <template #suffix>
            <button
      ...
      <div class="mt-6 flex items-center justify-between px-2">
        <h3 class="px-2 py-1.5 text-sm text-ink-gray-5">空间</h3>
        <div class="space-x-1 flex items-center">
          <Button
            ...
            :tooltip="allGroupsExpanded ? '全部收起' : '全部展开'"
          >
